...
comp-mind-examined-catatonic = { CAPITALIZE(SUBJECT($ent)) } está totalmente { MAKEGENERO("catatônico", $ent) }. O estresse da vida no espaço deve ter sido demais. Qualquer recuperação é improvável.
